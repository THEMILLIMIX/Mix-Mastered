...
import { ShoppingBag, X, Sparkles, Layers, Plus, Minus, Award, Mic2, Users, Radio, Settings, AlertCircle, Cpu, BookOpen, Download, Loader2, CheckCircle2 } from 'lucide-react';
import { jsPDF } from "jspdf";
import html2canvas from "html2canvas";
import { ServiceCard } from './components/ServiceCard';
import { OptionCard } from './components/OptionCard';
import { BASE_SERVICES, OPTIONS, COMMERCIAL_OPTION } from './constants';
...
export default function App() {
  ...
  const total = subtotal + commercialCost;
  ...
  const handleQuantityUpdate = (itemId: string, delta: number) => {
    setCart(prev => {
      ...
      if (delta > 0) {
        const itemDef = [...BASE_SERVICES, ...OPTIONS].find(i => i.id === itemId);
        if (itemDef) {
                        ...
                        <div className="bg-[#0a0a0a] border border-neutral-900 rounded-2xl p-8 hover:border-neutral-800 transition-colors">
                            ...
                            <div className="flex flex-col gap-3">
                                <div className="text-neutral-300 text-sm flex items-center gap-3">
                                    ...
                                    THEBLACKLABEL - ALLDAY PROJECT 믹싱마스터링 참여중
                                </div>
                                <div className="text-neutral-300 text-sm flex items-center gap-3">
                                    <span className="w-1 h-1 bg-neutral-700 rounded-full shrink-0"></span>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    ...
                                    <ul className="list-disc pl-4 space-y-2 text-neutral-400 text-[11px] leading-relaxed marker:text-neutral-700">
                                        ...
                                        <li>모든 작업물은 THE MILLI MIX 시그니처 사운드를 포함하고 있습니다.</li>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="pt-4 border-t border-neutral-900">
                                    ...
                                    <div className="mt-4 p-3 bg-red-900/10 border border-red-900/20 rounded-lg">
                                        <p className="text-red-400 text-[10px] leading-relaxed font-medium">
                                            ⚠️ THE MILLI MIX 시그니처 사운드 제거 비용은 50,000원이 추가 됩니다. <br/>
                                            임의로 시그니처 사운드 제거시 저작권 침해로 내용증명 발송 후 한국저작권보호원 신고 및 민사소송이 진행됩니다.
                                        </p>
                                    </div>
                                </div>
                            </div>
